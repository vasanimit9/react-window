...
function createListComponent(_ref) {
  ...
  function (_PureComponent) {
    ...
    _proto.getRenderedItemRange = function getRenderedItemRange() {
    ...
    _proto.render = function render() {
      var _this$props4 = this.props,
          ...
          useIsScrolling = _this$props4.useIsScrolling,
          width = _this$props4.width,
          isSwipeDisabled = _this$props4.isSwipeDisabled,
          disableScrollBar = _this$props4.disableScrollBar;
      ...
      var estimatedTotalSize = getEstimatedTotalSize(this.props, this._instanceProps); // Changed By Keshav ::  disableScrollBar to hide scrollbar in list

      var temporaryClassNames = disableScrollBar ? 'disableScrollBar' : '';
      return react.createElement(outerElementType || outerTagName || 'div', {
    ...
    _proto._getRangeToRender = function _getRangeToRender() {
      ...
      var overscanBackward = !isScrolling || scrollDirection === 'backward' ? Math.max(0, overscanCount) : 0;
      var overscanForward = !isScrolling || scrollDirection === 'forward' ? Math.max(0, overscanCount) : 0;
